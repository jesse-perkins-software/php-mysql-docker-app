...
<script defer>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fetchAccounts();
        document.getElementById('subpage-new-transactions').value = "Expenses";
        document.getElementById('subpage-edit-transactions').value = "Expenses";
    });
    ...
    <?php include 'modal-functions.js' ?>

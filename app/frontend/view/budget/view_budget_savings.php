...
<script defer>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        loadSavingsCategoryBudgetAmounts();
    });
    ...
    function loadSavingsCategoryBudgetAmounts() {
        let xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function() {
            if (this.readyState === 4 && this.status === 200) {
                let data = JSON.parse(this.responseText);
        ...
        let query = "page=Budget&command=LoadSavingsBudgetCategoryAmounts&budgetCategory=Savings";
        xhttp.open("POST", "/../controller/controller.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhttp.send(query);
    }

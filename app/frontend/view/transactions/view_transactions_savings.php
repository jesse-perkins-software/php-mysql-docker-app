...
<script defer>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fetchAccounts();
        document.getElementById('subpage-new-transactions').value = "Savings";
        document.getElementById('subpage-edit-transactions').value = "Savings";
    });
